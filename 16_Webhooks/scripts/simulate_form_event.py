"""Send a simulated support form webhook to the FastAPI trigger service."""
...
# Allow scripts to run from the project root without installing as a package.
...
def send_event() -> None:
    """Send the sample form event, then poll the job status."""
    payload_path = PROJECT_ROOT / "data" / "form_event.json"
